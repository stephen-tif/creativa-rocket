...
Command: npx gltfjsx@6.5.0 public/models/office_desk/scene.gltf 
...
const OfficeDesk = (props) => {
  const { nodes, materials } = useGLTF('./models/office_desk/scene.gltf')
  return (
...
useGLTF.preload('./models/office_desk/scene.gltf')
