...
const BlurContainer = ({ children }) => {
    return (
        <div className="relative isolate px-6 pt-20 lg:px-8 z-10 h-screen">
            ...
            <div className="absolute inset-0 -z-20 bg-[url('./src/assets/fondo-principal-blanco.svg')] dark:bg-[url('./src/assets/fondo-principal-negro.svg')] bg-cover bg-center"/>
            <div className="absolute inset-0 -z-20 bg-[url('./src/assets/fondo-principal-burbujas.svg')] sm:opacity-15 opacity-0" />
